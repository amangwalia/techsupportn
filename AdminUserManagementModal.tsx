...
export const AdminUserManagementModal: React.FC<AdminUserManagementModalProps> = ({
  ...
  const refreshAccountsList = async () => {
    ...
    const currentAdmin = cached.find((a) => a.username.toLowerCase() === currentAdminUsername.toLowerCase()) || cached.find((a) => a.role === 'admin');
    if (currentAdmin) {
    ...
    try {
      ...
      setAccounts(fresh);
      const freshAdmin = fresh.find((a) => a.username.toLowerCase() === currentAdminUsername.toLowerCase()) || fresh.find((a) => a.role === 'admin');
      if (freshAdmin) {
